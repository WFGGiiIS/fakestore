...
function renderCartProducts() {
  ...
  if (products.length > 0 && products.some((product) => Boolean(product))) {
    let sum = 0;
    ...
    products.forEach((product) => {
      ...
      <div class="row">
        <div class="col">
          <img src="${product.image}" width="100" height="100" class="object-fit-contain">
        </div>
        <div class="col">
          ${product.title}
        </div>
    ...
    cartContainer.innerHTML += `<p style="text-align: right;">${sum} PLN</p>`
  }
  else{
